(() => {
  ...
  const blankState = () => ({
    ...clone(starterState), income: 0, incomeByMonth: {}, paycheckPlans: {}, billAssignments: {}, bills: [], expenses: [], paydays: [], moneyIn: [], goals: [], debts: [], envelopes: [], brainDump: [], notes: {}, intention: '', noSpendDays: [],
